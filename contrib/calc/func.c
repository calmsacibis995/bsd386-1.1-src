...
static struct builtin {
	...
	"frem", 2, 2, 0, OP_NOP, qfacrem, 0, "number with all occurances of factor removed",
	...
	"hash", 1, IN, 0, OP_NOP, 0, f_hash, "return non-negative hash value for one or more values",
