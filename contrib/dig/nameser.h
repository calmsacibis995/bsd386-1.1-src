...
**
** NOTE: One of the most often encountered problems when porting to
** different architectures is that the HEADER structure (~ line 125)
** is not defined.  You need to decide whether your machine is 'big-endian'
** or 'little-endian, and add appropriate "defined (mach)" statement.
*/
...
|| defined(MIPSEB) || defined(_MIPSEB) || defined (ibm032)
...
|| defined(MIPSEL) || defined(_MIPSEL) || defined (__bsdi__)
