...
string *tfmpath ;     /* pointer to directories for tfm files */
string *pkpath ;       /* pointer to directories for pk files */
string *vfpath ;       /* pointer to directories for vf files */
string *figpath ;     /* pointer to directories for figure files */
string *headerpath ; /* pointer to directories for header files */
string *configpath ;  /* where to find config files */
#ifndef PICTPATH
#ifndef __THINK__
#define PICTPATH "."
#else
...
#endif
#endif
string *pictpath ;   /* where IFF/etc. pictures are found */
#ifdef FONTLIB
