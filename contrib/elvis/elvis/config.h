/*	BSDI $Id: config.h,v 1.2 1994/01/15 07:12:57 polk Exp $	*/
...
# define PRESERVE       "/usr/contrib/lib/elvprsv"
# define PRSVDIR	"/var/preserve"	/* XXX */
...
#if ANY_UNIX && !INTERNAL_TAGS
# undef INTERNAL_TAGS
# define INTERNAL_TAGS	1
#endif
