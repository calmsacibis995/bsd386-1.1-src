/*	$Header: /bsdi/MASTER/BSDI_OS/contrib/flexfax/faxd/Class2Poll.c++,v 1.1.1.1 1994/01/14 23:09:46 torek Exp $
/*
...
{
    if (class2Cmd("CIG", (char*) pollID))	// set polling ID
	return (TRUE);
