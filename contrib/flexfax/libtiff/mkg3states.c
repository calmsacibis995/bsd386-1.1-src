#ifndef lint
static char rcsid[] = "$Header: /bsdi/MASTER/BSDI_OS/contrib/flexfax/libtiff/mkg3states.c,v 1.1.1.1 1994/01/14 23:10:04 torek Exp $";
#endif
 ...
 *
 *	Reference: $Id: mkg3states.c,v 1.1.1.1 1994/01/14 23:10:04 torek Exp $
 *
