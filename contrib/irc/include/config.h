/*	BSDI	$Id: config.h,v 1.1.1.1 1994/01/13 21:15:34 polk Exp $	*/
/************************************************************************
 ...
 */
#define	DPATH	"/etc/contrib/ircd"
#define	SPATH	"/usr/contrib/bin/ircd"	/* path to server executeable */
#define	CPATH	"/etc/contrib/ircd/ircd.conf"	/* server configuration file */
#define	MPATH	"/etc/contrib/ircd/ircd.motd"	/* server MOTD file */
 ...
 */
#define FNAME_USERLOG "/var/log/ircd_users" /* */
#define FNAME_OPERLOG "/var/log/ircd_opers" /* */
...
/* #define	UPHOST	"cairo.anu.edu.au" */
