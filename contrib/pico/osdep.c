/*	BSDI	$Id: osdep.c,v 1.1.1.1 1994/01/13 22:42:28 polk Exp $	*/
#if	!defined(lint) && !defined(DOS)
static char rcsid[] = "$Id: osdep.c,v 1.1.1.1 1994/01/13 22:42:28 polk Exp $";
#endif
/*
...
#if	(defined(bsd) || defined(dyn) || defined(ct)) && !defined(LINUX) && !defined(__bsdi__)
#define	SIGTYPE int
#else
#define	SIGTYPE	void
#endif
...
alt_editor(f, n)
{
    ...
    long   l;
#if	defined(POSIX) || defined(sv3) || defined(COHERENT) || defined(isc) || defined(__bsdi__)
    int    stat;
#else
    union  wait stat;
#endif
