...
char *strcpy(char *, const char *), *strcat(char *, const char *);
void exit(int), free(void *);
...
static readheader(void);	/* read a header chunk */
static readtrack(void);
static badbyte(int c);
static metaevent(int type);
static sysex (void);
...
void WriteVarLen (long unsigned int value);
...
{
    int i; void mf_write_track_chunk(int which_track, FILE *fp), mf_write_header_chunk(int format, int ntracks, int division);
...
mf_write_track_chunk(int which_track, FILE *fp)
{
	...
	void write16bit(int data),write32bit(long unsigned int data);
 ...
 */
int 
mf_write_midi_event(long unsigned int delta_time, unsigned int type, unsigned int chan, unsigned char *data, long unsigned int size)
{
    int i;
    void WriteVarLen(long unsigned int value);
    unsigned char c;
 ...
 */
int
mf_write_meta_event(long unsigned int delta_time, unsigned char type, unsigned char *data, long unsigned int size)
{
    int i;
...
void 
mf_write_tempo(long unsigned int tempo)
{
    /* Write tempo */
 ...
 */
void 
WriteVarLen(long unsigned int value)
{
 ...
 */
float 
mf_ticks2sec(long unsigned int ticks, int division, unsigned int tempo)
{
 ...
 */
void 
write32bit(long unsigned int data)
{
