/* $Header: /bsdi/MASTER/BSDI_OS/contrib/tcsh/grot/vms.termcap.c,v 1.2 1994/01/14 00:23:45 polk Exp $ */
/*
 ...
 */
#include "sh.h"
RCSID("$Id: vms.termcap.c,v 1.2 1994/01/14 00:23:45 polk Exp $")
#ifdef _VMS_POSIX
/*    efth      1988-Apr-29
