...

{
    ...
    /* how many lines to allocate for? */
    lines = smart_terminal ? screen_length - Header_lines : 1;

    /* allocate space for the screen buffer */
    screenbuf = (char (*)[Display_width])malloc(lines * Display_width);
...
char memory_buffer[Display_width];
...
static char next_msg[Display_width + 5];
static int msglen = 0;
...

{
    ...
    base = screenbuf[smart_terminal ? line : 0];
