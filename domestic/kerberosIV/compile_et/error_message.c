/*
 * $Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/compile_et/error_message.c,v 1.2 1992/01/04 18:35:22 kolstad Exp $
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/compile_et/error_message.c,v $
 * $Locker:  $
 *
