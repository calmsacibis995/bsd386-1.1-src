/*
 *
 * $Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/compile_et/init_et.c,v 1.2 1992/01/04 18:35:24 kolstad Exp $
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/compile_et/init_et.c,v $
 * $Locker:  $
 *
