/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb/krb_cache.c,v $
 * $Author: kolstad $ 
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb/krb_cache.c,v 1.2 1992/01/04 18:36:32 kolstad Exp $";
#endif	lint
