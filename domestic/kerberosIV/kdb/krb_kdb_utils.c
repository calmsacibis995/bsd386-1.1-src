/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb/krb_kdb_utils.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb/krb_kdb_utils.c,v 1.2 1992/01/04 18:36:37 kolstad Exp $";
#endif	lint
