/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb_destroy/kdb_destroy.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb_destroy/kdb_destroy.c,v 1.2 1992/01/04 18:36:43 kolstad Exp $";
#endif	lint
