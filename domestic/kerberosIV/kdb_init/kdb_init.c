/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb_init/kdb_init.c,v $
 * $Author: kolstad $ 
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kdb_init/kdb_init.c,v 1.2 1992/01/04 18:36:55 kolstad Exp $";
#endif	lint
