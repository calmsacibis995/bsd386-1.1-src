/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kerberos/kerberos.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kerberos/kerberos.c,v 1.2 1992/01/04 18:37:03 kolstad Exp $";
#endif  lint
