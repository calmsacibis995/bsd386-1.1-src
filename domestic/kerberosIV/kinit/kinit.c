/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kinit/kinit.c,v $
 * $Author: kolstad $ 
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kinit/kinit.c,v 1.2 1992/01/04 18:37:05 kolstad Exp $";
#endif	lint
