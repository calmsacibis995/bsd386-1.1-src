/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/klist/klist.c,v $
 * $Author: kolstad $ 
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/klist/klist.c,v 1.2 1992/01/04 18:37:08 kolstad Exp $";
#endif	lint
