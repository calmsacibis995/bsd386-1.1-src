/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/cr_err_reply.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/cr_err_reply.c,v 1.2 1992/01/04 18:37:15 kolstad Exp $";
#endif /* lint */
