/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/create_auth_reply.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/create_auth_reply.c,v 1.2 1992/01/04 18:37:17 kolstad Exp $";
#endif /* lint */
