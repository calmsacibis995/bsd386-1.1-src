/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/create_ciph.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/create_ciph.c,v 1.2 1992/01/04 18:37:19 kolstad Exp $";
#endif /* lint */
