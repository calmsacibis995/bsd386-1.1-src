/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/create_death_packet.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/create_death_packet.c,v 1.2 1992/01/04 18:37:21 kolstad Exp $";
#endif /* lint */
