/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/decomp_ticket.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/decomp_ticket.c,v 1.2 1992/01/04 18:37:32 kolstad Exp $";
#endif /* lint */
