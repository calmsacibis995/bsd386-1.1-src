/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_admhst.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_admhst.c,v 1.2 1992/01/04 18:37:43 kolstad Exp $";
#endif /* lint */
