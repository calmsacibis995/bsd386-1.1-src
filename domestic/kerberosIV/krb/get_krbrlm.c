/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_krbrlm.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_krbrlm.c,v 1.2 1992/01/04 18:37:52 kolstad Exp $";
#endif /* lint */
