/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_phost.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_phost.c,v 1.2 1992/01/04 18:37:54 kolstad Exp $";
#endif /* lint */
