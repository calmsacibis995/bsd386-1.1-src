/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_pw_tkt.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/get_pw_tkt.c,v 1.2 1992/01/04 18:37:56 kolstad Exp $";
#endif /* lint */
