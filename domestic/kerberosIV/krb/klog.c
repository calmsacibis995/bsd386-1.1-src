/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/klog.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/klog.c,v 1.2 1992/01/04 18:38:17 kolstad Exp $";
#endif /* lint */
