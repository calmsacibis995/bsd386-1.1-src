/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/kname_parse.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/kname_parse.c,v 1.2 1992/01/04 18:38:19 kolstad Exp $";
#endif /* lint */
