/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/kntoln.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/kntoln.c,v 1.2 1992/01/04 18:38:21 kolstad Exp $";
#endif /* lint */
