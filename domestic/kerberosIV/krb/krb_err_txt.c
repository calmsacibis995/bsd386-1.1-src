/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/krb_err_txt.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/krb_err_txt.c,v 1.2 1992/01/04 18:38:27 kolstad Exp $";
#endif	lint
