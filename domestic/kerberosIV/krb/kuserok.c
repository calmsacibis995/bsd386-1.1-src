/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/kuserok.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/kuserok.c,v 1.2 1992/01/04 18:38:35 kolstad Exp $";
#endif	lint
