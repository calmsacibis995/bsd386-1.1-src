/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/log.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/log.c,v 1.2 1992/01/04 18:38:37 kolstad Exp $";
#endif /* lint */
