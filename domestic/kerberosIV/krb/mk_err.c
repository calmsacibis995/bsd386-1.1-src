/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_err.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_err.c,v 1.2 1992/01/04 18:38:39 kolstad Exp $";
#endif /* lint */
