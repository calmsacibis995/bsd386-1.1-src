/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_priv.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_priv.c,v 1.2 1992/01/04 18:38:42 kolstad Exp $";
#endif /* lint */
