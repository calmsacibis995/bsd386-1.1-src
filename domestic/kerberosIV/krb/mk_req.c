/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_req.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_req.c,v 1.2 1992/01/04 18:38:44 kolstad Exp $";
#endif /* lint */
