/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_safe.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/mk_safe.c,v 1.2 1992/01/04 18:38:46 kolstad Exp $";
#endif /* lint */
