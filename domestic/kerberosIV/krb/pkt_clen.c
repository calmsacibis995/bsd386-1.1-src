/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/pkt_clen.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/pkt_clen.c,v 1.2 1992/01/04 18:38:57 kolstad Exp $";
#endif /* lint */
