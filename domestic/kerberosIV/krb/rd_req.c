/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/rd_req.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/rd_req.c,v 1.2 1992/01/04 18:39:05 kolstad Exp $";
#endif /* lint */
