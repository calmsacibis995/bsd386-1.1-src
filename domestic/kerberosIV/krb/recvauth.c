/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/recvauth.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/recvauth.c,v 1.2 1992/01/04 18:39:12 kolstad Exp $";
#endif	lint
