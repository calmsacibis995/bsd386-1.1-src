/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/save_credentials.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/save_credentials.c,v 1.2 1992/01/04 18:39:14 kolstad Exp $";
#endif /* lint */
