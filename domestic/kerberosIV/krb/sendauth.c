/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/sendauth.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/sendauth.c,v 1.2 1992/01/04 18:39:18 kolstad Exp $";
#endif	lint
