/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/stime.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/stime.c,v 1.2 1992/01/04 18:39:20 kolstad Exp $";
#endif /* lint */
