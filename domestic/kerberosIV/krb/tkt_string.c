/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/tkt_string.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/tkt_string.c,v 1.2 1992/01/04 18:39:26 kolstad Exp $";
#endif /* lint */
