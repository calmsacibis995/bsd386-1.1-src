/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/util.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/krb/util.c,v 1.2 1992/01/04 18:39:28 kolstad Exp $";
#endif	lint
