/*
 * $Source: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kstash/kstash.c,v $
 * $Author: kolstad $
 *
...
"$Header: /bsdi/MASTER/BSDI_OS/domestic/kerberosIV/kstash/kstash.c,v 1.2 1992/01/04 18:39:35 kolstad Exp $";
#endif	lint
