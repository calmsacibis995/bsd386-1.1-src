/*	BSDI $Id: bigint.h,v 1.1 1993/02/05 22:30:57 polk Exp $	*/
...
/* use bcopy(), since stdio uses it in preference to memcpy() */
#if 0
#define Bcopy(x,y) memcpy((char *)&x->sign, (char *)&y->sign, \
y->wds*sizeof(long) + 2*sizeof(int))
#else
#define	Bcopy(x, y) \
	bcopy(&y->sign, &x->sign, y->wds*sizeof(long) + 2*sizeof(int))
#endif
