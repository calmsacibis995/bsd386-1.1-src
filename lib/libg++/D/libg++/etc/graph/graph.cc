...
double x_lower_limit = DBL_MAX;	// DBL_MAX means get it from the data
double x_margin = 0.0;		// fractional margin between data and box
double x_upper_limit = DBL_MAX;	// DBL_MAX means get it from the data
...
double y_upper_limit = DBL_MAX;	// DBL_MAX means get it from the data
