/*	BSDI $Id: cpp.c,v 1.3 1993/10/28 19:59:58 donn Exp $	*/
...
enum node_type {
 ...
 T_NOTUSED	/* Used for something not defined.  */
 };
  ...
  for (i = 1; i < argc; i++) {
      ...
      case 'I':			/* Add directory to path for includes.  */
	{
	  ...
	  if (! ignore_srcdir && !strcmp (argv[i] + 2, "-"))
	    ...
	    if (dirtmp->fname[0] == '.' && dirtmp->fname[1] == '\0')
	      dirtmp->fname = 0;	/* Current directory */
