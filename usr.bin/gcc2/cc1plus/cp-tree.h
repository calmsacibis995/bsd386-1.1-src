...
#ifndef NEW_CLASS_SCOPING
#define NEW_CLASS_SCOPING 1
#endif
...
extern tree get_unique_fn			PROTO((tree));
...
extern tree delete_sanity			PROTO((tree, tree, int));
...
extern tree build_component_ref			PROTO((tree, tree, tree, int));
extern tree build_ptrmemfunc			PROTO((tree, tree));
