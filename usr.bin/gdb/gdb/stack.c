...
static void
printsource_command (retval_exp, from_tty)
     char *retval_exp;
     int from_tty;
{
	if (info_printsource)
		++print_source_at_stop;
	else
		--print_source_at_stop;
}

...
#endif
  c = add_set_cmd("printsource", class_stack, var_boolean,
		  (char *)&info_printsource,
		  "Set auto print of source lines at step/breakpoint.",
		  &setlist),
  add_show_from_set(c, &showlist);
  c->function.sfunc = printsource_command;
}
