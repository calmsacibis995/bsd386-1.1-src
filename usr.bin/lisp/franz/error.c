#ifndef lint
static char *rcsid =
   "$Header: /bsdi/MASTER/BSDI_OS/usr.bin/lisp/franz/error.c,v 1.2 1992/01/04 18:54:42 kolstad Exp $";
#endif
 ...
 * is of an "undefined error type" ER%misc .  Soon all calls tosunid
or the 'print' property an.
 *
 */
