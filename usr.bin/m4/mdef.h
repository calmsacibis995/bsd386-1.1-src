/*	@(#)BSDI $Id: mdef.h,v 1.2 1993/12/16 04:44:07 sanders Exp $ */
...
#else
#define MAXSTR          2048            /* maximum size of string  */
#define BUFSIZE        65536            /* size of pushback buffer */
#define STACKMAX        8192            /* size of call stack      */
