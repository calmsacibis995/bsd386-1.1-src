/*	BSDI $Id: main.c,v 1.2 1994/01/05 02:30:15 torek Exp $	*/
 ...
 *
 *
 * Stanford Id: main.c,v 1.5 1993/06/24 05:11:16 deering Exp
 */
...
static char pidfilename[]  = PATH_PIDFILE;
static char dumpfilename[] = PATH_DUMPFILE;
